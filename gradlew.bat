...
@rem Prefer Android Studio embedded JBR (JDK 17) for AGP jlink compatibility
if not defined JAVA_HOME (
  for %%P in (
    ...
    "%LOCALAPPDATA%\Programs\Eclipse Adoptium\jdk-17.0.18.8-hotspot"
    "%ProgramFiles%\Eclipse Adoptium\jdk-17.0.18.8-hotspot"
